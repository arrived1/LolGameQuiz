...
public class GameFragmentWithGPlus extends Fragment implements View.OnClickListener,
    ...
    public GameFragmentWithGPlus(){}

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {

        View rootView = inflater.inflate(R.layout.fragment_game_with_gplus, container, false);
